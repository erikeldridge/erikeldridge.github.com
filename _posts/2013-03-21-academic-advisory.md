...
1. Observe Twitter maintains several projects on Github
...
A BarCamp is a self-organizing conference, a.k.a., an [unconference](http://en.wikipedia.org/wiki/Unconference). Everyone is welcome, and anyone can propose a talk. A great assignment would be to attend a local camp, present a brief talk on an area of interest, and report on the experience.
...
1. search [meetup.com](http://meetup.com) for a topic related to any area of the curriculum requiring support
1. attend a meeting to get a feel for the group
1. suggest a meetup at your location
...
As in a school for martial arts, CoderDojo defines a set of [belts](http://coderdojo.com/about-us/belt-rankings/) (white, yellow, red, black) for coding ability. Students ascend in rank by learning technologies and skill-sets such as JavaScript, Python, game development, and mentorship.
...
For debugging, I recommend [jdb](http://docs.oracle.com/javase/1.3/docs/tooldocs/solaris/jdb.html) or [gdb](http://gcc.gnu.org/java/gdb.html), on the command-line or via an IDE. IntelliJ provides a free communitiy edition with an excellent debugging interface.
...
* proficiency with git will make interactions with [Github](https://github.com/) much more straightforward
